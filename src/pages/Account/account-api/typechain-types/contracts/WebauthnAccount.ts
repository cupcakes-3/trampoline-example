...
export interface WebauthnAccountInterface extends utils.Interface {
  functions: {
    ...
    "initialize(address,uint256[2])": FunctionFragment;
    "initialize(address)": FunctionFragment;
    "nonce()": FunctionFragment;
    "owner()": FunctionFragment;
    "proxiableUUID()": FunctionFragment;
    "q(uint256)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "ec", values?: undefined): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "initialize(address,uint256[2])",
    values: [
      PromiseOrValue<string>,
  ...
  decodeFunctionResult(functionFragment: "ec", data: BytesLike): Result;
...
export interface WebauthnAccount extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WebauthnAccountInterface;
  ...
  functions: {
    ...
    ec(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    ec(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    ec(overrides?: CallOverrides): Promise<PopulatedTransaction>;
